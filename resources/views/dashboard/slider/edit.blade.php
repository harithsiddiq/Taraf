                                        ...
                                        <div class="col-md-12 row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{ $slide->name_ar }}" name="name_ar" type="text" class="form-control" id="exampleInputEmail1" placeholder="مثلا صورة عمالة بنجلاديش">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input value="{{ $slide->name_en }}" name="name_en" type="text" class="form-control" id="exampleInputEmail1" placeholder="مثلا صورة عمالة بنجلاديش">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                        ...
                        <div class="box pull-up ">
                            <div class="box-body card-body text-center">
                                ...
                                <div class="= justify-content-between align-items-center">
                                    ...
                                    <h3 class="font-weight-700 mt-0">4 </h3>
